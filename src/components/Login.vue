<template>
  ...
  <v-card
    style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); max-width: 450px; width: 80%; border-radius: 10px;">
    ...
    <div style="flex: 1; padding: 50px;">
      <div
        style="background: linear-gradient(45deg, #6949EA, #DF4CF2); -webkit-background-clip: text; -webkit-text-fill-color: transparent; justify-content: center; display: flex; font-size: 40px; margin-bottom: 20px; font-weight: 600;">
        Bienvenido I&B</div>
      <div
        style="justify-content: center; display: flex; color: #919290; font-size: 30px; margin-bottom: 20px; font-weight: 100; text-shadow: 1px 2px 1px #df4cf2;">
        Iniciar Sesión</div>
